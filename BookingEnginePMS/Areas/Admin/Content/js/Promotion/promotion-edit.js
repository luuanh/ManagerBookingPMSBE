...
app.controller('controller', ['$scope', '$http', '$log', 'uiGridConstants', 'validate', 'notify', '$location',
    function ($scope, $http, $log, uiGridConstants, validate, notify, $location) {
        ...
        $scope.Put = function () {
            ...
            $http({
                ...
                location.replace("/Admin/Promotion/Index")
