var app = angular.module('app',
    [
        'ui.grid', 'ngSanitize', 'ui.grid.selection', 'ui.grid.cellNav',
        'ui.grid.resizeColumns', 'ui.grid.moveColumns', 'ngTouch',
...
var statusInvoice = [
    "<span class='uk-badge-looked'>" + 'Chưa thanh toán' + "</span>",
    "<span class='uk-badge-active'>" + 'Đã thanh toán' + "</span>"
];
var getFeedBack = [
